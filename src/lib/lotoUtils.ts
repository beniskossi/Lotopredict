...
export const getBallColor = (number: number): string => {
  ...
  if (number >= 20 && number <= 29) return 'bg-orange-500 text-orange-100 border-orange-700'; // Orange
  if (number >= 30 && number <= 39) return 'bg-green-500 text-green-100 border-green-700'; // Vert
  ...
  if (number >= 60 && number <= 69) return 'bg-indigo-500 text-indigo-100 border-indigo-700'; // Indigo
  if (number >= 70 && number <= 79) return 'bg-amber-700 text-amber-100 border-amber-900'; // Brun (utilisant amber de Tailwind)
