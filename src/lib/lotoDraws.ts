...
// Some icons used above are not standard in lucide-react, so here are fallbacks or simple representations.
// This is a workaround since I cannot generate SVGs.
...
const WalletIcon = (props: React.SVGProps<SVGSVGElement>) => (
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 12V8H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v4"/><path d="M4 18c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2h16v proteína            4c0 1.1-.9 2-2 2H6"/><path d="M18 12.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"/></svg>
);
...
const Dice5Icon = (props: React.SVGProps<SVGSVGElement>) => (
